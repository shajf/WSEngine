 ...
 */
ACMP *acmp_duplicate(ACMP *parser, ngx_pool_t *pool);
 ...
 */
ngx_int_t acmp_process(ACMP *parser, const char *data, size_t len);
 ...
 */
ACMPT *acmp_duplicate_quick(ACMP *parser, ngx_pool_t *pool);
