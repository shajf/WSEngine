...
#define NGX_FINFO_SIZE   0x00000100
...
/*shajf add*/
#define NGX_FILEPATH_NOTABOVEROOT   0x01

/** internal: Only meaningful with NGX_FILEPATH_NOTABOVEROOT */
#define NGX_FILEPATH_SECUREROOTTEST 0x02

/** Cause apr_filepath_merge to fail if addpath is above rootpath,
 * even given a rootpath /foo/bar and an addpath ../bar/bash
 */
#define NGX_FILEPATH_SECUREROOT     0x03

/** Fail apr_filepath_merge if the merged path is relative */
#define NGX_FILEPATH_NOTRELATIVE    0x04

/** Fail apr_filepath_merge if the merged path is absolute */
#define NGX_FILEPATH_NOTABSOLUTE    0x08

/** Return the file system's native path format (e.g. path delimiters
 * of ':' on MacOS9, '\' on Win32, etc.) */
#define NGX_FILEPATH_NATIVE         0x10

/** Resolve the true case of existing directories and file elements
 * of addpath, (resolving any aliases on Win32) and append a proper 
 * trailing slash if a directory
 */
#define NGX_FILEPATH_TRUENAME       0x20

#define NGX_PATH_MAX 8192

#define NGX_FLOCK_SHARED        1       /**< Shared lock. More than one process
                                           or thread can hold a shared lock
                                           at any given time. Essentially,
                                           this is a "read lock", preventing
                                           writers from establishing an
                                           exclusive lock. */
#define NGX_FLOCK_EXCLUSIVE     2       /**< Exclusive lock. Only one process
                                           may hold an exclusive lock at any
                                           given time. This is analogous to
                                           a "write lock". */

#define NGX_FLOCK_TYPEMASK      0x000F  /**< mask to extract lock type */
#define NGX_FLOCK_NONBLOCK      0x0010  /**< do not block while acquiring the
                                           file lock */
